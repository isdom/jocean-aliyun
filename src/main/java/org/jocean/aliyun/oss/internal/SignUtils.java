...
public class SignUtils {
    ...
    */
    ...
    private static String buildCanonicalizedResource(final String resourcePath, final Map<String, List<String>> parameters) {
        ...
        if (parameters != null) {
            final String[] parameterNames = parameters.keySet().toArray(
