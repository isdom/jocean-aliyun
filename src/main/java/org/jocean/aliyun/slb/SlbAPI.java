...
//        SetLoadBalancerHTTPListenerAttributeBuilder backendServerPort(final int backendServerPort);
    ...
    interface DescribeLoadBalancerHTTPSListenerAttributeResponse extends SLBAPIResponse {
        ...
        @JSONField(name="EnableHttp2")
        String getEnableHttp2();

        @JSONField(name="EnableHttp2")
        void setEnableHttp2(final String enableHttp2);

        @JSONField(name="TLSCipherPolicy")
        Integer getTLSCipherPolicy();

        @JSONField(name="TLSCipherPolicy")
        void setTLSCipherPolicy(final String tlsCipherPolicy);
